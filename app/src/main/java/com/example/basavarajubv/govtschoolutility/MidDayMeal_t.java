...
public class MidDayMeal_t extends AppCompatActivity
{
  ...
  {
    Intent intent = new Intent(this, StudentsStrengths_t.class);
...
//  }
  ...
  public void onActivityResult(int requestCode, int resultCode, Intent data)
  {
    ...
    String strength = data.getStringExtra(StudentsStrengths_t.KEY_STRENGTH);
